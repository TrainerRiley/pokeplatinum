...
enum BallCapsuleSelectorState {
    BALL_CAPSULE_SELECTOR_INIT = 0,
    BALL_CAPSULE_SELECTOR_FADE_IN,
    BALL_CAPSULE_SELECTOR_WAIT_FOR_FADE_IN,
    BALL_CAPSULE_SELECTOR_MAIN,
    BALL_CAPSULE_SELECTOR_EDIT_MENU,
    BALL_CAPSULE_SELECTOR_START_FADEOUT,
    BALL_CAPSULE_SELECTOR_EXIT,
    BALL_CAPSULE_SELECTOR_EXIT_EDITOR,
};

enum BallCapsuleEditorState {
    BALL_CAPSULE_EDITOR_INIT,
    BALL_CAPSULE_EDITOR_INIT_START_FADE_OUT,
    BALL_CAPSULE_EDITOR_INIT_WAIT_FOR_FADE_OUT,
    BALL_CAPSULE_EDITOR_INIT_WAIT_FOR_FADE_IN,
    BALL_CAPSULE_EDITOR_MAIN,
    BALL_CAPSULE_EDITOR_DEMO_EFFECT,
    BALL_CAPSULE_EDITOR_CONFIRM,
    BALL_CAPSULE_EDITOR_CANCEL,
    BALL_CAPSULE_EDITOR_EXIT_START_FADE_OUT,
    BALL_CAPSULE_EDITOR_EXIT_WAIT_FOR_FADE_OUT,
...
enum BallCapsuleButtons {
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT1 = 0,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT2,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT3,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT4,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT5,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT6,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT7,
    BALL_CAPSULE_BUTTON_SEAL_PAGE_SLOT8,
