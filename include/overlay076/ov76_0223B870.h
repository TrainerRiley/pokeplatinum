...
void BallCapsuleSystem_SetDrawPointerSprites(BallCapsuleSystem *ballCapsuleSys, int param1);
...
void BallCapsuleSystem_SwapCapsules(BallCapsuleSystem *ballCapsuleSys, int param1, int param2);
...
void CreateWindowWithScroll(BgConfig *param0, Window *param1, int param2, int param3, int param4, int param5, int param6, int param7);
...
void BallCapsuleSystem_UpdateWindowSealCount(BallCapsuleSystem *ballCapsuleSys, int param1);
